...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func PostMessageCreated(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.MessageController, roomID int, payload *app.MessagePayload) (http.ResponseWriter, *app.Message) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
